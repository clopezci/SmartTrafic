...
export const waitByCrossing = [
  { cruce: "CR-01 Parque", adaptativo: 18, fijo: 45, motos: 62 },
  { cruce: "CR-02 Colegio", adaptativo: 22, fijo: 45, motos: 48 },
  { cruce: "CR-03 Variante", adaptativo: 16, fijo: 45, motos: 31 },
  { cruce: "CR-04 Hospital", adaptativo: 29, fijo: 45, motos: 22 },
];

export const batteryWeek = [
  { d: "Mar 2", cr01: 91, cr02: 78, cr03: 55, cr04: 41 },
  { d: "Mar 3", cr01: 88, cr02: 74, cr03: 49, cr04: 33 },
  { d: "Mar 4", cr01: 84, cr02: 71, cr03: 44, cr04: 26 },
  { d: "Mar 5", cr01: 90, cr02: 76, cr03: 52, cr04: 22 },
  { d: "Mar 6", cr01: 93, cr02: 80, cr03: 58, cr04: 19 },
  { d: "Mar 7", cr01: 89, cr02: 75, cr03: 46, cr04: 18 },
  { d: "Hoy", cr01: 87, cr02: 72, cr03: 41, cr04: 18 },
];
...
export const heatRows = [
  ...
  { cruce: "CR-03", vals: [0.35, 0.7, 0.65, 0.55, 0.6, 0.55, 0.5, 0.45, 0.5, 0.55, 0.6, 0.8, 0.7, 0.4, 0.25] },
  { cruce: "CR-04", vals: [0.2, 0.35, 0.3, 0.25, 0.3, 0.4, 0.35, 0.3, 0.35, 0.4, 0.35, 0.45, 0.4, 0.3, 0.2] },
];

export const matrix = [
  { code: "CR-01", name: "Parque × Calle Real", wait: 18, health: 98, bat: 87, motos: 184, status: "ok", mode: "Adaptativo" },
  { code: "CR-02", name: "Colegio San José", wait: 22, health: 94, bat: 72, motos: 141, status: "ok", mode: "Colegio" },
  { code: "CR-03", name: "Entrada Sur", wait: 16, health: 81, bat: 41, motos: 96, status: "ok", mode: "Adaptativo" },
  { code: "CR-04", name: "Hospital", wait: 29, health: 54, bat: 18, motos: 38, status: "eco", mode: "Eco solar" },
];
...
export const scopeLabel: Record<BiScope, string> = {
  villa: "Villa Esperanza · 4 cruces",
  cedro: "El Cedro · 2 cruces demo",
  red: "Red piloto · 6 alcaldías",
};

export const insights = [
  { tone: "stop" as const, text: "CR-04 Hospital: 18% batería · 16 min sin heartbeat" },
  { tone: "wait" as const, text: "Pico 18:00 — 164 vehículos, 74% motos" },
  { tone: "go" as const, text: "Espera −28% vs ciclo fijo 45 s · 6.2 gal ahorrados hoy" },
];
...
export const alertFeed = [
  ...
  { sev: "info", cruce: "CR-03", title: "Cola de carga 3+ ejes", ago: "hace 2 h" },
  { sev: "ok", cruce: "CR-02", title: "Modo colegio activo 06:50", ago: "hoy" },
];
